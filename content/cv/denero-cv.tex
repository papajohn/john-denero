...
Google, Inc.               & {\it Phone:} & (415) 203-1943\\
1600 Amphitheater Parkway  & {\it Email:} & denero@google.com\\
...
\section{\sc Position}
	...
	\dated{Senior research scientist for Google Translate, Mountain View, CA}
	{ 2010-present } \\
...
\section{\sc Teaching}
	...
	\dated{ {\bf Instructor} \\
	CS 61A: Structure and Interpretation of Computer Programs, an introductory
	computer science course at UC Berkeley.} {2011-2013} \\

	\dated{ {\bf Instructor} \\
	CS 188: Introduction to Artificial Intelligence, an advanced undergraduate
	course.} {2009} \\

	\dated{ {\bf Tutorial Organizer} \\
	...
	Hopkins University, co-taught with Adam Lopez. } {2009-2010} \\

	\dated{ {\bf Graduate Student Instructor} \\
	Support staff for CS 188 in charge of discussion sections, labs, review
	sessions, and project development.} {2005-2007} \\
...
John DeNero and Aditi Muralhindaran.  ``Twitter Trends,'' in {\it Nifty Assignments track of the ACM Special Interest Group on Computer Science Education}, 2013.
...
{\bf Organizing Committee}: EAAI '13, NACLO/ELCLO '13, NACLO/ELCLO '14
...
ACL '12, EMNLP '12, EAAI '12, NAACL '13, ACL '13, EMNLP '13
